...
`define kINST_MEM_SIZE                      16'h2000    // Modify linker script to e.g. `. = {kINST_MEM_SIZE};`
 ...
 */
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SLTU       10'b0000000001
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SLT        10'b0000000010
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_ADD        10'b0000000100
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SUB        10'b0000001000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_XOR        10'b0000010000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_OR         10'b0000100000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_AND        10'b0001000000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SLL        10'b0010000000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SRL        10'b0100000000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_SRA        10'b1000000000
`define kSAIL_MICROARCHITECTURE_ALUCTL_9to0_ILLEGAL    10'b0000000000

`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BEQ        7'b0000001
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BNE        7'b0000010
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BLT        7'b0000100
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BGE        7'b0001000
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BLTU       7'b0010000
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_BGEU       7'b0100000
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_JUMP       7'b1000000
`define kSAIL_MICROARCHITECTURE_BRUCTL_6to0_ILLEGAL    7'b0000000
